...
describe('\'Making an appointment\' complaint', () => {

  it('should add the data to the SQS queue', async() => {
    // Select correct complaint category
    await page.goto(baseURL);
    const complaintTypeRadio = await page.$('input#reason-immigration-appointment');
    await complaintTypeRadio.check();
    await submitPage();

    // Problem radio
    const problemRadio = await page.$('input#immigration-appointment-complain-appointments');
